...
private:
  ...
  struct userbalance {
    ...
    GSTLIB_SERIALIZE(userbalance, (username)(cloudwallet)(total)(balance))
  };
  ...
  struct playertable {
    ...
    GSTLIB_SERIALIZE(playertable, (player_name)(cloudwallet)(keys)(amount))
  };
  ...
  struct counter {
    ...
    GSTLIB_SERIALIZE(counter, (owner)(last_buyer)(cloudwallet)(last_buy_time)(end_time)(time_count)(
