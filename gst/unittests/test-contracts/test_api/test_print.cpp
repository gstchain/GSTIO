...
void test_print::test_printn() {
   printn(gstio::name{"1"}.value);
   printn(gstio::name{"5"}.value);
   printn(gstio::name{"a"}.value);
   printn(gstio::name{"z"}.value);

   printn(gstio::name{"abc"}.value);
   printn(gstio::name{"123"}.value);

   printn(gstio::name{"abc.123"}.value);
   printn(gstio::name{"123.abc"}.value);

   printn(gstio::name{"12345abcdefgj"}.value);
   printn(gstio::name{"ijklmnopqrstj"}.value);
   printn(gstio::name{"vwxyz.12345aj"}.value);

   printn(gstio::name{"111111111111j"}.value);
   printn(gstio::name{"555555555555j"}.value);
   printn(gstio::name{"aaaaaaaaaaaaj"}.value);
   printn(gstio::name{"zzzzzzzzzzzzj"}.value);
}
