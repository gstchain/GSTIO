...
void test_crypto::test_sha1() {
   gstio::checksum160 tmp;

   tmp = gstio::sha1( test1, my_strlen(test1) );
   gstio_assert( my_memcmp((void *)test1_ok_1, &tmp, sizeof(gstio::checksum160)), "sha1 test1" );

   tmp = gstio::sha1( test3, my_strlen(test3) );
   gstio_assert( my_memcmp((void *)test3_ok_1, &tmp, sizeof(gstio::checksum160)), "sha1 test3" );

   tmp = gstio::sha1( test4, my_strlen(test4) );
   gstio_assert( my_memcmp((void *)test4_ok_1, &tmp, sizeof(gstio::checksum160)), "sha1 test4" );

   tmp = gstio::sha1( test5, my_strlen(test5) );
   gstio_assert( my_memcmp((void *)test5_ok_1, &tmp, sizeof(gstio::checksum160)), "sha1 test5" );
}

void test_crypto::test_sha256() {
  gstio::checksum256 tmp;

  tmp = gstio::sha256( test1, my_strlen(test1) );
  gstio_assert( my_memcmp((void *)test1_ok_256, &tmp, sizeof(gstio::checksum256)), "sha256 test1" );

  tmp = gstio::sha256( test3, my_strlen(test3) );
  gstio_assert( my_memcmp((void *)test3_ok_256, &tmp, sizeof(gstio::checksum256)), "sha256 test3" );

  tmp = gstio::sha256( test4, my_strlen(test4) );
  gstio_assert( my_memcmp((void *)test4_ok_256, &tmp, sizeof(gstio::checksum256)), "sha256 test4" );

  tmp = gstio::sha256( test5, my_strlen(test5) );
  gstio_assert( my_memcmp((void *)test5_ok_256, &tmp, sizeof(gstio::checksum256)), "sha256 test5" );
}

void test_crypto::test_sha512() {
  gstio::checksum512 tmp;

  tmp = gstio::sha512( test1, my_strlen(test1) );
  gstio_assert( my_memcmp((void *)test1_ok_512, &tmp, sizeof(gstio::checksum512)), "sha512 test1" );

  tmp = gstio::sha512( test3, my_strlen(test3) );
  gstio_assert( my_memcmp((void *)test3_ok_512, &tmp, sizeof(gstio::checksum512)), "sha512 test3" );

  tmp = gstio::sha512( test4, my_strlen(test4) );
  gstio_assert( my_memcmp((void *)test4_ok_512, &tmp, sizeof(gstio::checksum512)), "sha512 test4" );

  tmp = gstio::sha512( test5, my_strlen(test5) );
  gstio_assert( my_memcmp((void *)test5_ok_512, &tmp, sizeof(gstio::checksum512)), "sha512 test5" );
}

void test_crypto::test_ripemd160() {
  gstio::checksum160 tmp;

  tmp = gstio::ripemd160( test1, my_strlen(test1) );
  gstio_assert( my_memcmp((void *)test1_ok_ripe, &tmp, sizeof(gstio::checksum160)), "ripemd160 test1" );

  tmp = gstio::ripemd160( test3, my_strlen(test3) );
  gstio_assert( my_memcmp((void *)test3_ok_ripe, &tmp, sizeof(gstio::checksum160)), "ripemd160 test3" );

  tmp = gstio::ripemd160( test4, my_strlen(test4) );
  gstio_assert( my_memcmp((void *)test4_ok_ripe, &tmp, sizeof(gstio::checksum160)), "ripemd160 test4" );

  tmp = gstio::ripemd160( test5, my_strlen(test5) );
  gstio_assert( my_memcmp((void *)test5_ok_ripe, &tmp, sizeof(gstio::checksum160)), "ripemd160 test5" );
}

void test_crypto::sha256_null() {
  gstio::checksum256 tmp;
  tmp = gstio::sha256( nullptr, 100);
...
void test_crypto::sha1_no_data() {
  ...
  tmp = gstio::sha1( test2, my_strlen(test2) );
  gstio_assert( my_memcmp((void *)test2_ok_1, &tmp, sizeof(gstio::checksum160)), "sha1 test2" );
}

void test_crypto::sha256_no_data() {
  gstio::checksum256 tmp;

  tmp = gstio::sha256( test2, my_strlen(test2) );
  gstio_assert( my_memcmp((void *)test2_ok_256, &tmp, sizeof(gstio::checksum256)), "sha256 test2" );
}

void test_crypto::sha512_no_data() {
  gstio::checksum512 tmp;

  tmp = gstio::sha512( test2, my_strlen(test2) );
  gstio_assert( my_memcmp((void *)test2_ok_512, &tmp, sizeof(gstio::checksum512)), "sha512 test2" );
}

void test_crypto::ripemd160_no_data() {
  gstio::checksum160 tmp;

  tmp = gstio::ripemd160( test2, my_strlen(test2) );
  gstio_assert( my_memcmp((void *)test2_ok_ripe, &tmp, sizeof(gstio::checksum160)), "ripemd160 test2" );
}
