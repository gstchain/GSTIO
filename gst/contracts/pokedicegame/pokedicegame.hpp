...
class pokedicegame : public contract {
   ...
   private:
    ...
    void parse_memo(string memo, uint8_t* roll_under) 
    {
        // remove space
    ...
    asset compute_referrer_reward(const st_bet& bet) { return bet.bet_amount / 200; }
    ...
    string referrer_memo(const st_bet& bet) {
        ...
        memo.append(player);
        memo.append(" referral reward! - pokediced");
        return memo;
    }
