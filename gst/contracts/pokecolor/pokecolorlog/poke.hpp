...
private:
 ...
 struct st_result {
    ...
    struct betitem {
        ...
        uint64_t get_account() const { return account; }
   ...
   // typedef gstio::multi_index<N(bet), betitem> bet_index;
    typedef gstio::multi_index< N(bet), betitem,indexed_by<N(account),const_mem_fun<betitem, uint64_t, betitem::get_account>>> bet_index;
    bet_index bets;
