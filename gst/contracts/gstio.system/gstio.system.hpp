...
struct producer_info
{
	...
	// explicit serialization macro is not necessary, used here only to improve compilation time
	GSTLIB_SERIALIZE(producer_info, (owner)(total_votes)(producer_key)(is_active)(url)(unpaid_blocks)(last_claim_time)(location)(votes_from_voters)(total_blocks)(votes_rate)(last_vote_unclaim)(bunclaim)(vunclaim)(unclaim)(cbunclaim)(cvunclaim)(cunclaim))
};
...
struct voter_info
{
	...
	// explicit serialization macro is not necessary, used here only to improve compilation time
	GSTLIB_SERIALIZE(voter_info, (owner)(proxy)(producers)(staked)(last_staked)(last_claim_time)(last_vote_weight)(proxied_vote_weight)(is_proxy)(reserved1)(reserved2)(reserved3))
};
